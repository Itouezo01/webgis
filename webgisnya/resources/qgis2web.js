...
map.getView().fit([12530830.189518, -890465.954263, 12544007.669983, -883847.765067], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Warner di Lowokwaru</h2>';
        return titleElement;
    })(),
